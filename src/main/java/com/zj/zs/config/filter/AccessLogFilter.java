...
public class AccessLogFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        AccessLogDTO accessLogDTO = converter.toDTO(sessionId, requestURI,
                request.getMethod(),
        ...
        log.info("AccessLogFilter##doFilter: requestURI={}, remoteAddr={} sessionId={}, localAddr={}, parameterMap={}, requestBody={}",
                requestURI, remoteAddr, requestedSessionId, localAddr, JsonUtils.toString(parameterMap), requestBody);
